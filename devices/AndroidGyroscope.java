...
public class AndroidGyroscope implements ILoggingDeviceBuilder {
    ...
    class Logger extends AbstractLogger {
        ...
        public void init(Context context) {
            ...
            if (profile.getArgValue("save-data").equals("1")) {
                this._csv = new TextDataWriter("gyro", "time,x,y,z");
                ...
                this._csv.setExceptionCatch(new TextDataWriter.IExceptionCatch() {
                        ...
                        public void caught(Exception e) {
                            self.onException(new LoggerException("Android Gyroscope CSV Error!"));
                            e.printStackTrace();
                        }
                    });
            }
        ...
        public void start(final IAsyncCallback callback) {
            ...
            Sensor sensor = this._manager.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
