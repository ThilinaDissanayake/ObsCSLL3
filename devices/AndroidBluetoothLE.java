...
import com.sroom.cslablogger.positioning.BtScanManager;
...
public class AndroidBluetoothLE implements ILoggingDeviceBuilder {
    ...
    class Logger extends AbstractLogger {
        ...
        public void init(Context context) {
            ...
            if (profile.getArgValue("save-data").equals("1")) {
                this._csv = new TextDataWriter("bluetoothle", "time,");
