...
public final class AndroidMagnetic implements ILoggingDeviceBuilder {

        @Override
        public DeviceProfile initDeviceProfile() {
            return new DeviceProfile(
                    "android magnetic",
                    R.drawable.ic_androidmagnetic,
                    true,
                    new ArgValue[] {
        ...
        class Logger extends AbstractLogger {
            ...
            public void init(Context context) {
                ...
                if (profile.getArgValue("save-data").equals("1")) {
                    this._csv = new TextDataWriter("magnetic", "time,x,y,z");
                    ...
                    this._csv.setFileRename(new TextDataWriter.IFileRename() {
                        ...
                        public String rename(Date dt) {
                            return String.format("%s_magnetic.csv",
                    ...
                    this._csv.setExceptionCatch(new TextDataWriter.IExceptionCatch() {
                        ...
                        public void caught(Exception e) {
                            self.onException(new LoggerException("Android Magnetic CSV Error!"));
                            e.printStackTrace();
                        }
                    });
                }
            ...
            public void start(final IAsyncCallback callback) {
                ...
                Sensor sensor = this._manager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD);
