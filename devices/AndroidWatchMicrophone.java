...
public final class AndroidWatchMicrophone { //implements ILoggingDeviceBuilder {
}
/**
    @Override
    public DeviceProfile initDeviceProfile() {
        return new DeviceProfile(
            "android watch microphone",
            R.drawable.ic_watchmicrophone,
            true,
            new ArgValue[] {
                new ArgValue("samplerate", "8000",
                                 new SingleChoiceSelector("44.1KHz=44100,8000Hz=8000")),
        ...
        abstract class RecThread extends AbstractLoggerThread {
            ...
            public RecThread() {
                ...
                this._rec = new AudioRecord(MediaRecorder.AudioSource.MIC,
                                            owner._samplerate,
                                            AudioFormat.CHANNEL_CONFIGURATION_MONO,
                                            AudioFormat.ENCODING_PCM_16BIT, this._buffer.length * 2);
